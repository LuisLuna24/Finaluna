<x-m-modal wire:model="incomeModal" title="{{ $editingIncomeIndex !== null ? 'Editar ingreso' : 'Registrar ingreso' }}">
    <div class="space-y-6">
        {{-- BASIC DATA --}}
        <div class="space-y-4">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <x-m-input label="Monto" prefix="$" wire:model.live="incomeAmount" type="number" step="0.01"
                    placeholder="0.00" />
            </div>
        ...
        <div class="rounded-2xl border border-base-300 bg-base-200/30 p-5">
            ...
            <div class="mt-5">
                <x-m-range wire:model.live="incomeSavingsAllocation" min="0" max="100" class="range-primary"
                    step="1" />
            </div>
