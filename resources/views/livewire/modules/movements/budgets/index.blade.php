<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <x-m-button link="{{ route('movements.budgets.create') }}" icon="o-plus" label="Nuevo presupuesto"
            class="btn-primary" />
    </div>
            ...
            {{ $excedido ? 'border-error/30' : 'border-base-200' }}">
                ...
                <div class="flex items-start justify-between gap-3">
                    ...
                    <x-m-dropdown>
                        ...
                        <x-m-menu-item icon="o-document-plus" title="Ingresos"
                            link="{{ route('movements.budgets.incomes', $budget->id) }}" />
                        <x-m-menu-item icon="o-document-currency-dollar" title="Gastos"
                ...
                <div class="mt-5">
                    ...
                    <div class="mb-2 flex items-center justify-between">
                        ...
                        <span class="text-xs font-medium text-base-content/70">
                            ${{ number_format($budget->presupuesto, 2) }}
                        </span>
                ...
                <div class="mt-5 grid grid-cols-2 gap-3">
                    ...
                    <div class="rounded-xl bg-base-200/50 p-3">
                        ...
                        <p class="mt-1 text-sm font-semibold text-success">
                            ${{ number_format($budget->ingreso, 2) }}
                        </p>
            ...
            <div class="md:col-span-2 lg:col-span-4">
                <div class="rounded-2xl border border-dashed border-base-300 bg-base-200/30 px-6 py-12 text-center">
                    ...
                    <p class="mx-auto mt-1 max-w-md text-sm text-base-content/60">
                        Registra tu primer presupuesto para comenzar a planificar tus gastos.
                    </p>
                    <div class="mt-5">
                        <x-m-button icon="o-plus" label="Agregar" link="{{ route('movements.budgets.create') }}" />
                    </div>
                </div>
            </div>
        @endforelse
